...
By using the `showtext` package internally, `plot2` supports any font and downloads the missing fonts automatically if required:

```{r}
mtcars %>%
  plot2(mpg, hp, family = "Rock Salt")
```
