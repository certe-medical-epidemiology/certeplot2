...
Any installed font and any Google Font is supported in `plot2`, since it uses the  `showtext` package internally. Missing fonts will be downloaded automatically:
...
These objects can be given to `plot2()`, and its built-in `theme_minimal2()` makes sure you get a clean map:
