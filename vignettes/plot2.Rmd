...
Now we had to use 8 functions in total, and define all variables twice. In other words, a lot of redundant code. And why is y = 0 not on the x baseline and are my bars floating, and why is 2009 so wide?? If you know the answers, you're way deeper into `ggplot2` than should be necessary.
