...
Now we had to use 7 functions to get the desired functional part of the plot while defining all variables twice. The styling part took another 6 functions. In other words, a lot of redundant code. And why 2009 is still so wide?? I'll give you this: if you know the solution, you're way deeper into `ggplot2` than should ever be necessary to use an R package. 
