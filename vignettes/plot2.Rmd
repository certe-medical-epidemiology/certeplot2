...
Besides using `x.date_breaks` and `x.date_labels`, the x axis has an option `x.date_remove_years` that can be set to `TRUE` to remove years from the `x` values. This allows to categorise by year:

```{r}
df <- data.frame(date = seq(as.Date("2021-01-01"), as.Date("2023-12-31"), "1 day"),
