...
#' @rdname plot2-extensions
#' @importFrom ggplot2 aes facet_wrap geom_col ggplot labs position_dodge2 geom_errorbar
...
plot2.antibiogram <- function(.data,
                              ...
                              facet = NULL,
                              type = "column",
                              x.title = "Antibioticum",
                              y.title = ifelse(isTRUE(attributes(.data)$combine_SI), "Percentage %SI", "Percentage %S"),
                              category.title = NULL,
                              title = NULL,
                              subtitle = NULL,
                              caption = NULL,
  ...
  df <- attributes(.data)$long_numeric
  
  if ("syndromic_group" %in% colnames(df)) {
    df |>
      plot2(x = ab,
            y = coverage,
            category = syndromic_group,
            facet = mo,
            type = type,
            x.title = {{ x.title }},
            y.title = {{ y.title }},
...
#' @export
plot2.detect_disease_clusters <- function(.data,
                                          x = NULL,
                                          y = NULL,
                                          category = NULL,
                                          facet = NULL,
